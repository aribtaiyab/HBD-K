...
export default function Chapter6({ onNext }) {
  ...
  const captionText =
    "[MEMORY]\n memory????? voto hai hi nhi hammne kabhi baat hi nhi ki, jab sammne bhi aa jati  phir bhi  kya pata kyu nhi hoti baat koina ajj apka birthday cake cut kariaa inashallah apke saare dua qabool ho aur mera liya bhi dua karia mai bhi kuch karu zindagi mein 😭😭😭 ... \n i hope apko ye acha laga ho ,  keep smiling ,ghumia phiria mazeeeee kariaaaa.";
